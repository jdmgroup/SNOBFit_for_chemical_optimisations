function addOutput(SNOB)
	...
	addlistener(SNOB, 'linked', 'PostSet', @(src,event)snobfitclass.snobHandler.setLinkedBounds(SNOB,src,event));
	addlistener(SNOB, 'xyMax', 'PostSet', @(src,event)snobfitclass.snobHandler.setLinkedBounds(SNOB,src,event));
	addlistener(SNOB, 'xyMin', 'PostSet', @(src,event)snobfitclass.snobHandler.setLinkedBounds(SNOB,src,event));
	addlistener(SNOB, 'minRatio', 'PostSet', @(src,event)snobfitclass.snobHandler.setLinkedBounds(SNOB,src,event));
	addlistener(SNOB, 'maxRatio', 'PostSet', @(src,event)snobfitclass.snobHandler.setLinkedBounds(SNOB,src,event));
	addlistener(SNOB, 'zMax', 'PostSet', @(src,event)snobfitclass.snobHandler.setLinkedBounds(SNOB,src,event));
	addlistener(SNOB, 'zMin', 'PostSet', @(src,event)snobfitclass.snobHandler.setLinkedBounds(SNOB,src,event));
